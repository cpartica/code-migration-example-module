...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->scopeConfig->getValue($code, \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $store);
    }
    ...
    {
        return $this->scopeConfig->getValue('blog/blog/enabled', \Magento\Store\Model\ScopeInterface::SCOPE_STORE) && $this->extensionEnabled('Titans_Blog');
    }
